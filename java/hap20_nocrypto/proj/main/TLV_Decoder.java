...
public class TLV_Decoder
{
    private int ptr = 0;
    private int method =  0; //such as 4=delete pairing
    private byte[] t1 = null; // name
    private byte[] t2 = null; // salt (read by client side only)
